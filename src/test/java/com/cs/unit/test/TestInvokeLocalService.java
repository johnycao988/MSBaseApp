...
class TestInvokeLocalService {
	...
	@Test
	void test() throws MessageException, BaseAppException {
		MessageRequest req = MessageFactory.getRequestMessage(
		...
		MSBaseApplication.getMessageBroker().invokeService(req);
	}
